 ...
 * @since 2.5
 *
 * 持有beanDefinition的一些属性
 */
public class BeanDefinitionDefaults {

	private boolean lazyInit;

	private int autowireMode = AbstractBeanDefinition.AUTOWIRE_NO; //自动装配类型

	private int dependencyCheck = AbstractBeanDefinition.DEPENDENCY_CHECK_NONE; //依赖检查类型
