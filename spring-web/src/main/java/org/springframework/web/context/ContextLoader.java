...
public class ContextLoader {
	...
	static {
		...
		//改静态代码块在类的初始化前会把ContextLoader.properties加载进来
		//改文件中指定了创建web的类型为：XmlWebApplicationContext
		try {
	...
	public WebApplicationContext initWebApplicationContext(ServletContext servletContext) {
		//web.xml中配置了多个contextLoaderListener
	 ...
	 * @see #CONTEXT_CLASS_PARAM
	 * @see org.springframework.web.context.support.XmlWebApplicationContext
	 * 改方法调用之前会通过类中的静态代码块把要创建的web容器的类型加载进来
	 * 并把他封装在defaultStrategies；类型为XmlWebApplicationContext
	 */
